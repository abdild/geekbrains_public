...
function handleClick(clickedButtonEvent) {
    ...
    let txtButton = card.button.innerText;
...
function showMoreText(card) {
    ...
    let txtDesc = 'Бла-бла-бла бла-бла-бла бла-бла-бла бла-бла-бла бла-бла-бла.';
    
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML("afterend", `<div class="desc">${txtDesc}</div>`);
